...
<body>
	...
	<div class="content">
		...
		<div class="innerOuter">
			...
			<br>
			<div>
				<form id="enrollForm" method="post" action="insert.fibo"
					enctype="multipart/form-data">
					<table>

						<div>
							<input type="text" id="title" class="form-control"
								style="margin-bottom: 20px;" value="" name="fishingTitle"
								required placeholder="제목을 입력해주세요"></input> <label for="upfile"></label>
									<input type="text" id="1212321" class=""
								  style="margin-bottom: 20px; border: none;"value="" name=""
								 placeholder="썸네일용 사진을 첨부해주세요" readonly required></input>
								
							</th> <input type="file" id="upfile" class="form-control-file border"
								name="upfile" required style="float: left;"
								onchange="uploadFile(this)" ></input> <input type="hidden"
								id="title" value="${loginUser.memNick}" name="fishingWriter"
						...
						<div
							...
							<div style="height: 100%; margin-bottom: 20px;">
								<!-- 실제로는 이미지의 경로를 적어주세요. -->
								<img id="yourImageContainer" style="height: 361px;width: 525px;">
							</div>
	...
	<script>
		...
		function uploadFile(input) {
		  ...
		  document.getElementById('upfile').addEventListener('change', function() {
		        document.getElementById('1212321').placeholder = '';
		    });
	</script>
