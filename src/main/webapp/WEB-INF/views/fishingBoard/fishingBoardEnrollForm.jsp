					...
					<table>
						...
						<div>
							<input type="text" id="title" class="form-control"
								style="margin-bottom: 20px;" value="" name="fishingTitle" required
								placeholder="제목을 입력해주세요" ></input> <label for="upfile"></label>
							</th> <input type="file" id="upfile" class="form-control-file border"
								name="upfile" required style="float: left;" onchange="uploadFile(this)"></input>
						...
						<div>
							<td id="content"></td>
						<textarea id="summernote" name="fishingContent"style="resize: none; margin-bottom: 20px; height: 100%;"></textarea>
						</div>
					</table>
					<br>
