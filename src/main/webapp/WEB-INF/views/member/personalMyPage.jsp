						...
						<c:forEach var="r" items="${reserList}">
							...
							<div style="width: 70%; margin-bottom: 30px;" class="card">
								<div class="card-header"
									...
									onclick="location.href='myReservationDetail?revNo=${r.revNo}'">
									<div
										style="display: flex; flex-direction: row; justify-content: space-between;">
										<span style="font-weight: bold;">${r.rstoreName}</span> <span
											style="font-size: 13px;">No. ${r.revNo}</span>
									</div>
