			...
			<table>
				<tr>
					<td><input type="text" id="title" class="form-control"
						value="${b.freeTitle}" style="margin-bottom: 20px;"
						name="freeTitle" required></td>
					<input type="hidden" id="title" class="form-control"
						value="${b.freeNo}" style="margin-bottom: 20px;" name="freeNo"
						required>
				</tr>

				<tr>
					<td id="content"><textarea id="summernote" name="freeContent"
							style="resize: none; margin-bottom: 20px; height: 100%;">${b.freeContent}</textarea></td>
