...
<!-- CSS-->
<link rel="stylesheet" href="<%=contextPath%>/resources/css/storeEnrollForm.css">

<!-- JS-->
<script src="<%=contextPath%>/resources/js/storeEnrollForm.js"></script>
...
<body>
	<jsp:include page="../common/header.jsp"/>
		<br><br><br><br><br><br>
	<div class="top-line">
		<h1 class="head-text" style="color: rgb(59, 175, 252);">사업장 추가</h1>
	</div>
	<br><br>
