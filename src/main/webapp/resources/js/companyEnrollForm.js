...
function addFishKind(){
    ...
    fishKind.insertAdjacentHTML("beforeend",'<br><tr><td colspan="4"><input name="StoreFishKindArray" placeholder="어종을 입력해주세요." style="width: 100%; margin: 0px auto;" class="form-control" type="text"></td></tr>')
}
