...
function updateList(date){
	...
	$.each(date, function (index, store) {
	            ...
	            +'<span class="like"><img style="height: 12px;" src="resources/images/like.png" alt="">111</span>'
	            +'</p><p class="address"><span>'+store.storeAddress+'</span></p><div class="price-area"><p>9,000<span>원</span></p></div></div></div></a>';
            });
